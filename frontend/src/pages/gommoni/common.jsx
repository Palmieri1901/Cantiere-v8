...
export const EMPTY_GOMMONE = {
  ...
  portata_persone: 0, potenza_max_hp: 0, peso_kg: 0, carena: "", tessuto: "", dotazioni: "",
...
export const EMPTY_PREV_GOMMONE = {
  ...
  compartimenti: 0, portata_persone: 0, potenza_max_hp: 0, peso_kg: 0, carena: "", tessuto: "",
...
export const gommonePayload = (f) => ({
  ...
  peso_kg: numOrZero(f.peso_kg), prezzo_pubblico: numOrZero(f.prezzo_pubblico), ordine: Math.round(numOrZero(f.ordine)),
});
